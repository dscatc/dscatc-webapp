...
[![Heroku](http://heroku-badges.herokuapp.com/?app=dscatc&style=flat)](http://dscatc.herokuapp.com/)


Live version: [Site](http://dscatc.herokuapp.com/)
...
2. Reach out to `shashank.sharma98@gmail.com` so that we can add you to the ATC organization.
...
`git clone https://github.com/dscatc/dscatc-webapp`
...
`CREATE ROLE dsc WITH LOGIN PASSWORD 'password';`
...
`GRANT ALL PRIVILEGES ON DATABASE dscatc TO dsc;`
...
DATABASE_URL: `postgresql://dsc:password@localhost/dscatc`
...
<img src="https://i.imgur.com/LgWoJHT.jpg" />
...
<img src="https://imgur.com/vlqvoA6.jpg" />
